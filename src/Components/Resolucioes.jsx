...
const ResolucionesHandler = ({ ResolucionesFileUpload }) => {
  ...
  const archivosHandler = async (e) => {
    try {
      ...
      for (let i = 0; i < archivos.length; i++) {
        ...
        await ResolucionesFileUpload(archivo, setUploadProgress);
      }
...
// Validación de props
ResolucionesHandler.propTypes = {
    ResolucionesFileUpload: PropTypes.func.isRequired // Función para manejar la carga de archivos, requerida
};

export default ResolucionesHandler;
